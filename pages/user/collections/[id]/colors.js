...
export default function CollectionColors(){
    ...
    return (
        <PCTemplate name={collection.name} collections={[collection]}>
            <PCSearchTemplate name={collection.name} title={`Colors (${colors?.count})`} menuMore={menuMore}/>
            ...
            <div className="h-[calc(100vh-60px-60px-36px)] md:h-[calc(100vh-60px-80px-68px)] flex flex-col gap-4 items-center justify-center text-gray-500">
