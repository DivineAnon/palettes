...
import { DashboardLoading, DashboardSearch, DashboardTemplate, PaletteDashboard, DashboardLoadingSearch } from "../../../components";
import { colorsGroup, GetToken, stylesPalette } from "../../../lib";
import { fetchMorePalettesDashboard, selectDashboardPalettes, selectDashboardPalettesPage, selectLoadingFetchMoreDashboardPalettes, selectQueryListDashboardPalette, setDashboardPalettes } from "../../../slices/dashboardSlice";
...
export default function PalettesDashboard(){
    ...
    const fetchPalettes = () => {
        dispatch(fetchMorePalettesDashboard(getQuery(query,parseInt(palettePage)+1)));
    }
