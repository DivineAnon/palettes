...
export default function PaletteSaves({ data }){
        ...
        <div className='flex flex-col gap-1.5'>
            ...
            <div className='flex items-center justify-between px-2'>
                ...
                <div className="flex gap-2 items-center justify-end">
                    <div onClick={()=>dispatch(handleSavePalette(user,data.palette.palette,'save',null))} className='flex items-center gap-0.5 text-[#7d7c83] hover:text-black transition cursor-pointer'>
